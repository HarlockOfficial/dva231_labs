...
<html lang="en">
	...
	<body>
		<form action="#" method="post" id="login-form">
			<input type="text" placeholder="username" /><span class="text-red invisible" id="username-error">*</span><br/>
			<input type="password" placeholder="********"/><span class="text-red invisible" id="password-error">*</span><br/>
